...
if [ -e wg0.conf ]; then
    ...
    read -p "WireGuard configuration file (wg0.conf) already exists. Do you want to overwrite it? (y/n): " overwrite
    if [ "$overwrite" != "y" ]; then
...
PrivateKey = ${p}
" > wg0.conf 
echo "WireGuard configuration file (wg0.conf) has been created or overwritten."
